        ...
        <div class="addLessonContent" >
            ...
            <div class="row">
                <div class="mb-3 col-6">
                    ...
                    <select class="form-select" aria-label="Default select example" id="EducationModule">
                    </select>
                </div>
...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
        ...
        // Populate the editor with the content from data.content_lesson
        editor.setData(data.content_lesson);
    } )
    .catch( error => {
        console.error( error );
    } );;
    ...
    function handleBreadcumbLessonData() {
        ...
        fetch(`/api/page-education-lesson/${lesson_id}`)
            ...
            .then(data => {
                ...
                lessonTitleElement.textContent = `Update Lesson: ${data.name_lesson}`;
    ...
    //     // Get the Values
       ...
       const editorData = editor.getData();
        ...
        fetch(`/api/update-education-lesson/${lesson_id}`, {
            method: 'PUT',
            headers: {
        ...
        .then(data => {
            ...
            if(data == 0) {
                ...
                UpdatedEducationLesson(educationCourseModuleId);;
    ...
    // // /* Update */
    function UpdatedEducationLesson(Module_id) {
        // Construct the URL with the provided ID
        var url = `/education_view_lesson/${Topic_id}/${Difficulty_id}/${Course_id}/${Module_id}/${lesson_id}`;
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin-IT\Desktop\tru-international\example-app\resources\views/education/educationUpdate.blade.php ENDPATH**/ ?>