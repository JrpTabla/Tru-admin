...
<div class="main">
    ...
    <div class="row m-auto p-3">
        <h1 class="text-center">Contents For Pages</h1>
        <div class="col-sm-6 col-xl-4 p-3">
            <a href="/contents_homepage" class="card navigation-section p-3">
                ...
                <img src="<?php echo e(asset ('assets/images/contents/Homepage/Images.PNG')); ?>" alt="" width="100%">
                <div class="card-body">
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin-IT\Desktop\tru-international\example-app\resources\views/contents/contents.blade.php ENDPATH**/ ?>