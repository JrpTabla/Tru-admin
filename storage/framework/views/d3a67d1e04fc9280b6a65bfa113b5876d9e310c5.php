...
<link rel="stylesheet" href="<?php echo e(asset ('assets/css/dashboard/member.css')); ?>">
    ...
    <div class="w-100 p-3">
        ...
        <nav aria-label="breadcrumb mt-3 ">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active fw-bold" aria-current="page">Education Management</li>
            </ol>
        </nav>
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin-IT\Desktop\tru-international\example-app\resources\views/education/educational.blade.php ENDPATH**/ ?>