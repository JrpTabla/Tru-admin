            ...
            <div class="user-details row my-5">
                <div class="col-4 profile-nav-div p-5">
                    ...
                    <div class="mt-5 navigation-div w-100">
                        ...
                        <div class="navigation-link text-white fw-bold ms-5 mb-2 nav-active">Additional Details Management</div>
...
<?php echo $__env->make('header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin-IT\Desktop\tru-international\example-app\resources\views/member/user_details.blade.php ENDPATH**/ ?>